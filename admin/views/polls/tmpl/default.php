...
<form action="index.php?option=com_mijopolls&amp;controller=polls&amp;task=view" method="post" name="adminForm"
      id="adminForm">
                ...
                <td>
                    ...
                    else
                    {
                        ...
                        <span class="editlinktip hasTip"
                              title="<?php echo JText::_('COM_MIJOPOLLS_EDIT_POLL'); ?>::<?php echo $row->title; ?>">
